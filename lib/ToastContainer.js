...
import { ViewPropTypes, StyleSheet, View, Text, Animated, Dimensions, TouchableWithoutFeedback, Easing, Keyboard, Image } from "react-native";
            ...
            <View style={[styles.defaultStyle, position]} pointerEvents="box-none">
                ...
                >
                    ...
                    >
                        ...
                        {this.props.subTitle ? (
                            <Text style={[styles.subTitleTextStyle, props.textStyle, props.textColor && { color: props.textColor }]}>
                                {this.props.subTitle}
                            </Text>
                        ) : null}
                    </Animated.View>
